...
namespace DonutMaker
{
    public class ApplicationDbContext : DbContext
    {
        ...
        {
            options.UseSqlServer("Server=(localdb)\\mssqllocaldb; Database=Donut; Trusted_Connection=True").UseLazyLoadingProxies();
        }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Ingredient>().HasData(
                new Ingredient()
                {
                    Id = 1, Name = "Chocolate", DonutId = 1
                },
                new Ingredient()
                {
                    Id = 2,Name = "Milk",DonutId = 2
                },
                new Ingredient()
                {
                    Id = 3,Name = "Milk",DonutId = 3
                },
                new Ingredient()
                {
                    Id = 4,Name = "Milk",DonutId = 4
                },
                new Ingredient()
                {
                    Id = 5,Name = "Milk",DonutId = 5
                }
